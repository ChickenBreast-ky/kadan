...
export function workCommand(args,flags,context){
 ...
 if(flags.help&&action.startsWith('auto-'))return 'kadan work auto-configure <업무키> --revision N --implementation 원본카드키 --review 검수원본키 --worker 작업자 --reviewer 검수자 [--notify 감독 --deadline 기존시한 --next-block] | auto-show <업무키> | auto-report <업무키> --execution 현재실행키 --outcome implemented|pass|changes|exception --result-file 절대경로 | auto-step <업무키> | auto-run <업무키> [--interval 초]. 상세: docs/automatic-review.md';
