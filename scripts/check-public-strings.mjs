...
// 사용: node scripts/check-public-strings.mjs [경로...]  (기본: src tests scripts skills docs package.json README.md CONTRIBUTING.md NOTICE)
...
const targets=process.argv.slice(2).length?process.argv.slice(2):['src','tests','scripts','skills','docs','package.json','README.md','CONTRIBUTING.md','NOTICE'];
const files=[];
